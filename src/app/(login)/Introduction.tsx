				...
				<ContentContainer>
					...
					<SectionContainer>
						...
						<List>
							<List.Item>
								<TextLink
									url="https://worldcereal.github.io/worldcereal-documentation/processing/usage_cloud.html">
									WorldCereal documentation portal
								</TextLink>
							</List.Item>
							<List.Item>
								<TextLink
									url="https://documentation.dataspace.copernicus.eu/APIs/openEO/openeo_deployment.html">
									OpenEO documentation on CDSE
								</TextLink>
							</List.Item>
							<List.Item>
								<TextLink url="https://forum.esa-worldcereal.org/t/worldcereal-processing-hub/63">WorldCereal
									forum</TextLink>
							</List.Item>
						</List>
					</SectionContainer>
