	...
	return (
		<ContentContainer>
			<SectionContainer>
				...
				<TextParagraph>
					Use the different tabs on top to switch between different functionalities of the Hub.
				</TextParagraph>
				<List>
					<List.Item>
						<TextParagraph>
							...
							WorldCereal publishes several official,{' '}
							<TextLink url="https://esa-worldcereal.org/en/products/global-maps">global products</TextLink>. Here you
							can easily download one or multiple of these products for your area of interest.
						</TextParagraph>
					</List.Item>
					<List.Item>
						<TextParagraph>
							...
							Generate a cropland mask for your area and season of interest using the default WorldCereal cropland
							model.
						</TextParagraph>
					</List.Item>
					<List.Item>
			...
			<SectionContainer>
				...
				<TextParagraph>
					This application allows you to launch, monitor and download the result of WorldCereal processing jobs on the{' '}
					<TextLink url="https://dataspace.copernicus.eu/">Copernicus Data Space Ecosystem</TextLink> (CDSE).
				</TextParagraph>
				<TextParagraph>
				...
				<TextParagraph>
					WorldCereal uses{' '}
					<TextLink url="https://openeo.org/" color="var(--text-color)">
						openEO
					</TextLink>{' '}
				...
				<TextParagraph>
					...
					<br />
					<TextLink url="https://documentation.dataspace.copernicus.eu/APIs/openEO/openEO.html">
