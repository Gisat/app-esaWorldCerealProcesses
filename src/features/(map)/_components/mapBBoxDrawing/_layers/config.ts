...
export const BBOX_LAYER_POINT_RADIUS_MIN_PIXELS: number = 4;
export const BBOX_LAYER_POINT_RADIUS_MAX_PIXELS: number = 8;
...
export const BBOX_LAYER_LINE_WIDTH_MIN_PIXELS_DEFAULT: number = 1;
...
export const BBOX_LAYER_LINE_WIDTH_DEFAULT: number = 1;
export const BBOX_LAYER_COLOR_BLOCKED: [number, number, number] = [255, 0, 0]; // Red color when blocked
...
export const BBOX_LAYER_FILL_COLOR_EDIT_MODE: [number, number, number, number] = [190, 190, 190, 60]; // Fill color in edit mode
