      ...
      <div className="worldCereal-ProcessesTable-Details-column">
        {status === Statuses.error ? (
          <div className="worldCereal-ProcessesTable-Details-error">
            Your processing job resulted in an error. Please reach out to us on
            the{" "}
            <a
            ...
            , clearly mentioning the processing job ID as displayed in the first
        ...
        {results?.[0] && (
          <DetailsItem label={"Download results"}>
            {results.map((result) => (
              <div
                key={result.source_link}
                className="worldCereal-ProcessesTable-DetailItem-result"
              >
