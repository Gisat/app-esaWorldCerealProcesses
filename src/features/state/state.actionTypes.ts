...
export enum WorldCerealStateActionType {
	...
	CREATE_CUSTOM_PRODUCTS_SET_CROP_TYPE_MODEL_TYPE = 'createCustomProductsSetCropTypeModelType',
	CREATE_CUSTOM_PRODUCTS_SET_SEASONAL_MODEL_ZIP = 'createCustomProductsSetSeasonalModelZip',
	CREATE_CUSTOM_PRODUCTS_SET_ENABLE_CROPLAND_HEAD = 'createCustomProductsSetEnableCroplandHead',
	CREATE_CUSTOM_PRODUCTS_SET_LANDCOVER_HEAD_ZIP = 'createCustomProductsSetLandcoverHeadZip',
	CREATE_CUSTOM_PRODUCTS_SET_CROPTYPE_HEAD_ZIP = 'createCustomProductsSetCroptypeHeadZip',
	CREATE_CUSTOM_PRODUCTS_SET_MASK_CROPLAND = 'createCustomProductsSetMaskCropland',
	CREATE_CUSTOM_PRODUCTS_SET_POSTPROCESS_METHOD_CROPLAND = 'createCustomProductsSetPostprocessMethodCropland',
	CREATE_CUSTOM_PRODUCTS_SET_POSTPROCESS_KERNEL_SIZE_CROPLAND = 'createCustomProductsSetPostprocessKernelSizeCropland',
}
